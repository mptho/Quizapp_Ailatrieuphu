package baithi.ailatrieuphu.manager;
...
import baithi.ailatrieuphu.model.HighScore;
...
public class DatabaseManager {
    ...
    private final String DATABASE_NAME = "Question";
    private final String DATABASE_PATH =
            Environment.getDataDirectory().getAbsolutePath()
                    + "/data/baithi.ailatrieuphu/databases";
